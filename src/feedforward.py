...
if __name__ == "__main__":
    ...
    parser.add_argument('--distribution_head', type=str, choices=['poisson','negbin', 'tweedie', 'hsnb', 'zip'], default='tweedie', help="Specify distribution_head, default is 'tweedie'")
    ...
    model.eval()
    quantile_forecasts_list, mean_forecasts_list = [], []
    ...
    for i, batch in enumerate(test_dataloader):
        ...
        with torch.no_grad():
            ...
            mean_forecasts_list.append(samples.mean(axis=0).numpy())
    ...
    assert actuals.shape == mean_forecasts.shape 
