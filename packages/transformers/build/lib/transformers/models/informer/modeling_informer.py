...
class InformerMeanDemandScaler(nn.Module):
    """
...
class InformerMASEScaler(nn.Module):
    """
...
class InformerModel(InformerPreTrainedModel):
    def __init__(self, config: InformerConfig):
        ...
        if config.scaling == "mean" or config.scaling is True:
            ...
            self.scaler = InformerMeanDemandScaler(config)
        elif config.scaling == "MASE":
            self.scaler = InformerMASEScaler(config)
        else:
