...
class AutoformerMeanDemandScaler(nn.Module):
    """
...
class AutoformerMASEScaler(nn.Module):
    """
...
class AutoformerModel(AutoformerPreTrainedModel):
    def __init__(self, config: AutoformerConfig):
        ...
        if config.scaling == "mean" or config.scaling is True:
            ...
            self.scaler = AutoformerMeanDemandScaler(config)
        elif config.scaling == "MASE":
            self.scaler = AutoformerMASEScaler(config)
        else:
